export const guestTechTeamLead = {
    ...
    why: "Les avantages que vous apportent un chef invité pour vos équipes\xa0!",


    menu: [

        "vienna-philharmonic-orchestra|Comparons d'abord avec la musique classique",
    
        "our-experience-in-Cambodia|Notre expérience avec le Cambodge",

        "benefits-for-you|Les avantages pour vos équipes",
  ...
  classicalMusic: [
      ...
      "Parmi les ensembles musicaux les plus prestigieux au monde, il y a l'Orchestre Philharmonique de Vienne.",

      "Cet orchestre a une particularité que n'ont pas d'autres orchestres de haut rang: depuis 1933, %leurs musiciens n'ont pas de chef d'orchestre permanent\xa0!%",

      "Tous leurs concerts se font %exclusivement sous la direction de chefs d'orchestre invités%\xa0; ces derniers sont à la tête d'autres orchestres prestigieux.",

      "Parmi de nombreux exemples, on peut citer\xa0:",

      `
        >le très célèbre chef de l'Orchestre Philharmonique de Berlin Herbert von Karajan
        >son légendaire prédécesseur Wilhelm Furtwängler
        >Maestro Christian Thielemann, qui a dirigé le Concert du Nouvel An 2024
        >Maestro Riccardo Muti, qui dirigera le Concert du Nouvel An le 1er Janvier 2025\xa0!
      `
